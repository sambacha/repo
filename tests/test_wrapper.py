...
class RepoWrapperUnitTest(RepoWrapperTestCase):
  ...
  """
    ...
    """
        ...
        self.assertEqual(
            self.wrapper.gitc_parse_clientdir("/gitc/manifest-rw/test/extra"), "test"
        )
        self.assertEqual(
            self.wrapper.gitc_parse_clientdir("/test/usr/local/google/gitc/test"),
            "test",
        )
        self.assertEqual(
            self.wrapper.gitc_parse_clientdir("/test/usr/local/google/gitc/test/"),
        ...
        self.assertEqual(
            self.wrapper.gitc_parse_clientdir("/test/usr/local/google/gitc/test/extra"),
            "test",
        )
